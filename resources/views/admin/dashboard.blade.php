...
<!-- Snippet -->
<section class="flex flex-col justify-center antialiased bg-gray-100 text-gray-600 pt-8">
    <div class="h-full">
        <!-- Table -->
        <div class="w-full max-w-2xl mx-auto bg-white shadow-lg rounded-sm border border-gray-200">
            <header class="px-5 py-4 border-b border-gray-100">
                <h2 class="font-semibold text-gray-800">Customers Rank</h2>
            </header>
            <div class="p-3">
                <div class="overflow-x-auto">
                    <table class="table-auto w-full">
                        ...
                        <tbody class="text-sm divide-y divide-gray-100">
                            {{-- @dd($rankUserPost[2]->profile_photo_path) --}}
                            @php
                                $i = 1;
                            @endphp
                                ...
                                <tr>
                                    ...
                                    <td class="p-2 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <div class="w-10 h-10 flex-shrink-0 mr-2 sm:mr-3"><img class="rounded-full" src="{{ 'http://127.0.0.1:8000/storage/'.$user->profile_photo_path }}" width="40" height="40" alt="Alex Shatov"></div>
