    <aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 " aria-label="Sidebar">
       ...
       <ul class="space-y-2 font-medium">
          <li>
             <a href="{{route('dashboard')}}" class="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-gray-100 d">
          ...
          <li>
              <a href="{{route('posts')}}" class="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-gray-100 d">
                ...
                {{-- <span class="inline-flex items-center justify-center w-3 h-3 p-3 ml-3 text-sm font-medium text-blue-800 bg-blue-100 rounded-full">12</span> --}}
             </a>
            </li>
            <li>
             <a href="{{route('users')}}" class="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-gray-100 d">
          ...
          <li>
              <a href="{{route('productAdmin')}}" class="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-gray-100 d">
          ...
          <li>
              <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-gray-100 d">
